        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-6 leading-tight">
              <span className=" text-5xl lg:text-6xl bg-clip-text bg-gradient-t-r from-blue-500 to-purple-600">
              Sophora
              </span>
          ...
          />
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <TypewriterEffect
              text={`Sure! I'll generate a professional resume for you. Here's how it works:

🔍 Provide your GitHub username so I can fetch your details.

📝 I'll generate a structured resume with your projects, skills, and experience.

✏️ You can review and edit everything before finalizing it.`}
              speed={10}
            />
                    </div>
                  </div>
